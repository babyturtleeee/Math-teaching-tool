...
def update_prop(self, value):
    if self.is_dragging:
        ...
        #C.scene.objects.get("z_arrow_head").location.x = -(x_size/2.0)
        #C.scene.objects.get("z_arrow_head").location.y =  (y_size/2.0)
        #C.scene.objects.get("z_arrow_head").location.z =  (variable_A*3.0)
